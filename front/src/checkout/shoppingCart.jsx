...
const ShoppingCart = () => {
  ...
  useEffect(() => {
    ...
    return (<>
      ...
      <Box width={"100%"} bgColor={"#282828"} height={"280px"} mt={"20px"} display={"flex"} flexDirection={"row"} alignItems={"center"} justifyContent={"space-around"}>
        {/* Footer */}
        <Image src='src/assets/cart/Frame 5.svg' height={"100px"}></Image>
        <Image src='src/assets/cart/Frame 19.svg' height={"100px"}></Image>
        <Image src='src/assets/cart/Frame 2.svg' height={"100px"}></Image>
        <Image src='src/assets/cart/Frame 4.svg' height={"100px"}></Image>
      </Box>
    </>
    );
  };
